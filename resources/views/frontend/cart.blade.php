                                ...
                                <table
                                    ...
                                    <tr>
                                        <td><img class="img-responsive"
                                                src="img/home/product-1.png"></td>
                                        <td>Galaxy S6 Edge (Quốc tế) hàng Like new 32GB
                                        </td>
                                        <td>
                                ...
                                <div class="row" id="total-price">
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        Tổng thanh toán: <span
                                            class="total-price">50.000.000 đ</span>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <a href="#" class="my-btn btn">Cập
                                            nhật</a>
                                        <a href="#" class="my-btn btn">Xóa giỏ
                                            hàng</a>
                                    </div>
                                </div>
                            </form>
